...
export function imageToAnsi(image, targetWidth, targetHeight) {
    const adjustedHeight = Math.floor(targetHeight * 0.5);
...
export function imageToSixel(image, targetWidth, targetHeight) {
    ...
    sixel += '\x1b[?25h';
    return sixel;
    function encodeSixelRun(color, count) {
        let out = '';
